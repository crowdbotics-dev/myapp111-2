"""
Django settings for myapp111_2 project.
...
WSGI_APPLICATION = 'myapp111_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myapp111_2 API",
    "DESCRIPTION": "API documentation for myapp111_2 App",
    "VERSION": "v1",
}
